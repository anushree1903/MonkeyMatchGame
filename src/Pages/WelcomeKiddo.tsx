...
const WelcomeKiddo: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <img
        src={start}
        className="absolute top-3/4 left-1/6 ml-36 w-40 md:left-3/4 md:top-3/4 md:mt-10 float-animation transition duration-100 transform hover:scale-110 hover:animate-none"
        onClick={handleClick}
