...
const InstPage: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <img
        src={play}
        className="absolute bottom-2 left-1/3 ml-2 w-40 md:left-3/4 md:top-3/4 md:mt-14 float-animation transition duration-100 transform hover:scale-110 hover:animate-none"
        onClick={handleClick}
        style={{ cursor: "pointer" }}
      />
